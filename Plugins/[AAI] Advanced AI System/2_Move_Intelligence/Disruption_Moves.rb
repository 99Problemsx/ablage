...
class Battle::AI
  ...
  alias_method :disruption_pbRegisterMove, :pbRegisterMove unless method_defined?(:disruption_pbRegisterMove) || private_method_defined?(:disruption_pbRegisterMove)
