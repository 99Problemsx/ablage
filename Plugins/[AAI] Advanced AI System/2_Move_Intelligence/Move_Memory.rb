...
class Battle
  alias_method :aai_memory_pbEndOfBattle, :pbEndOfBattle unless method_defined?(:aai_memory_pbEndOfBattle) || private_method_defined?(:aai_memory_pbEndOfBattle)
  def pbEndOfBattle
...
class Battle::Battler
  ...
  alias_method :aai_memory_pbUseMoveSimple, :pbUseMoveSimple unless method_defined?(:aai_memory_pbUseMoveSimple) || private_method_defined?(:aai_memory_pbUseMoveSimple)
  ...
  alias_method :aai_memory_pbUseMove, :pbUseMove unless method_defined?(:aai_memory_pbUseMove) || private_method_defined?(:aai_memory_pbUseMove)
