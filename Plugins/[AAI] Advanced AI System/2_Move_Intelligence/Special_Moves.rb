...
class Battle::AI
  ...
  alias_method :special_moves_pbRegisterMove, :pbRegisterMove unless method_defined?(:special_moves_pbRegisterMove) || private_method_defined?(:special_moves_pbRegisterMove)
