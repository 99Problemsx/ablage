...
#===============================================================================
class Battle
  alias_method :aai_tactical_cleanup_pbEndOfBattle, :pbEndOfBattle unless method_defined?(:aai_tactical_cleanup_pbEndOfBattle) || private_method_defined?(:aai_tactical_cleanup_pbEndOfBattle)
  def pbEndOfBattle
