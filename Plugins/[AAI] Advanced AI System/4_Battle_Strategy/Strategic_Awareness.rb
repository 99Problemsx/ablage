...
# Cleanup hook
class Battle
  alias_method :aai_strategy_cleanup_pbEndOfBattle, :pbEndOfBattle unless method_defined?(:aai_strategy_cleanup_pbEndOfBattle) || private_method_defined?(:aai_strategy_cleanup_pbEndOfBattle)
  def pbEndOfBattle
