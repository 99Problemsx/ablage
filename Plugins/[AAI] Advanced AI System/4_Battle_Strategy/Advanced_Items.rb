...
class Battle::AI
  ...
  alias_method :advanced_items_pbRegisterMove, :pbRegisterMove unless method_defined?(:advanced_items_pbRegisterMove) || private_method_defined?(:advanced_items_pbRegisterMove)
