...
class Battle::AI
  alias_method :doubles_strategy_pbRegisterMove, :pbRegisterMove unless method_defined?(:doubles_strategy_pbRegisterMove) || private_method_defined?(:doubles_strategy_pbRegisterMove)
