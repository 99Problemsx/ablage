...
class Battle::AI
  alias_method :priority_tiers_pbRegisterMove, :pbRegisterMove unless method_defined?(:priority_tiers_pbRegisterMove) || private_method_defined?(:priority_tiers_pbRegisterMove)
