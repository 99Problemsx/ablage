...
class Battle::AI
  ...
  alias_method :weather_wars_pbRegisterMove, :pbRegisterMove unless method_defined?(:weather_wars_pbRegisterMove) || private_method_defined?(:weather_wars_pbRegisterMove)
