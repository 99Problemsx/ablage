...
class Battle::AI
  alias_method :recoil_tracking_pbRegisterMove, :pbRegisterMove unless method_defined?(:recoil_tracking_pbRegisterMove) || private_method_defined?(:recoil_tracking_pbRegisterMove)
