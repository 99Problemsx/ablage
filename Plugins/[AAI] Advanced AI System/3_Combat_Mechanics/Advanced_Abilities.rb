...
class Battle::AI
  ...
  alias_method :advanced_abilities_pbRegisterMove, :pbRegisterMove unless method_defined?(:advanced_abilities_pbRegisterMove) || private_method_defined?(:advanced_abilities_pbRegisterMove)
