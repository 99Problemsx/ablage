...
class BitmapSprite < Sprite
  def initialize(width, height, viewport = nil)
    ...
    @text_themes = {}   # v22-Port: v22s BitmapSprite nutzt Text-Themes (add_text_theme/draw_themed_text)
    @initialized = true
  end
...
#===============================================================================
# v22-Port: EBDXs eigene ChangelingSprite (E21, camelCase addBitmap/changeBitmap)
# kollidiert mit v22s deutlich erweiterter ChangelingSprite (snake_case add_bitmap/
# change_bitmap + @changeling_data + initialize_changeling_data + BITMAPS-Konstante),
# die von v22-Kern-UI (Load-Panels, Summary-Cursor) subklassiert wird. EBDX nutzt
# seine eigene ChangelingSprite nirgends -> die Neudefinition ist entfernt, damit
# v22s vollstaendige Version steht.
#===============================================================================
