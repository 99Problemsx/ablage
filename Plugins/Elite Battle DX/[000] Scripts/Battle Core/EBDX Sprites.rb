...
class DynamicPokemonSprite
  ...
  def invert; return @sprite.invert; end
  # Essentials v22's particle player can apply a mask pattern directly to a
  # battler sprite. EBDX wraps the real Sprite, so forward the shader-backed
  # pattern API exposed by the Linux mkxp-z-ext runner.
  def pattern; return @sprite.pattern; end
  def pattern_blend_type; return @sprite.pattern_blend_type; end
  def pattern_opacity; return @sprite.pattern_opacity; end
  def pattern_scroll_x; return @sprite.pattern_scroll_x; end
  def pattern_scroll_y; return @sprite.pattern_scroll_y; end
  def pattern_zoom_x; return @sprite.pattern_zoom_x; end
  def pattern_zoom_y; return @sprite.pattern_zoom_y; end
  ...
  def invert=(val); @sprite.invert = val; end

  def pattern=(val); @sprite.pattern = val; end
  def pattern_blend_type=(val); @sprite.pattern_blend_type = val; end
  def pattern_opacity=(val); @sprite.pattern_opacity = val; end
  def pattern_scroll_x=(val); @sprite.pattern_scroll_x = val; end
  def pattern_scroll_y=(val); @sprite.pattern_scroll_y = val; end
  def pattern_zoom_x=(val); @sprite.pattern_zoom_x = val; end
  def pattern_zoom_y=(val); @sprite.pattern_zoom_y = val; end
  #-----------------------------------------------------------------------------
