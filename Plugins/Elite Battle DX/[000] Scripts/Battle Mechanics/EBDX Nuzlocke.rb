...
#===============================================================================
class PokemonBag
  alias add_ebdx_nuzlocke add unless self.method_defined?(:add_ebdx_nuzlocke)
  def add(*args)
    ret = add_ebdx_nuzlocke(*args)
    item = args[0]
...
#===============================================================================
# v22-Port: PokemonLoadScreen#pbStartLoadScreen -> UI::Load#main
class UI::Load
  alias pbStartLoadScreen_ebdx_nuzlocke main unless self.method_defined?(:pbStartLoadScreen_ebdx_nuzlocke)
  def main
