...
# =============================================================================
# ESSENTIALS v22 STORAGE INTEGRATION
# =============================================================================

UI::PokemonStorage::ACTIONS.add(:box_auto_sort, {
  :effect => proc { |screen|
    BoxAutoSort.show_sort_menu(screen.storage, screen.box)
    screen.refresh_box
  }
})

MenuHandlers.add(:storage_box_interact, :box_auto_sort, {
  "name"  => _INTL("Sort"),
  "order" => 25
})
