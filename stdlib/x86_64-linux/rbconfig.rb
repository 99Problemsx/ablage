...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/src/build-x86_64")
  ...
  CONFIG["configure_args"] = " '--prefix=/src/build-x86_64' '--host=x86_64-linux-gnu' '--enable-install-static-library' '--enable-shared' '--disable-install-doc' '--without-ext=openssl,readline,dbm,gdbm' '--with-static-linked-ext' '--disable-rubygems' '--without-gmp' 'host_alias=x86_64-linux-gnu' 'CC=cc' 'CFLAGS=-std=gnu99 -flto -I/src/build-x86_64/include -flax-vector-conversions -O3 ' 'LDFLAGS=-flto -L/src/build-x86_64/lib'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/src/build-x86_64"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-flto -L/src/build-x86_64/lib -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["CP"] = "cp"
  CONFIG["RM"] = "rm -f"
  CONFIG["PKG_CONFIG"] = "x86_64-linux-gnu-pkg-config"
  CONFIG["DOXYGEN"] = ""
  CONFIG["DOT"] = ""
  ...
  CONFIG["LDFLAGS"] = "-L. -flto -L/src/build-x86_64/lib -fstack-protector-strong -rdynamic -Wl,-export-dynamic -Wl,--no-as-needed"
  CONFIG["CFLAGS"] = "-std=gnu99 -flto -I/src/build-x86_64/include -flax-vector-conversions -O3  -fPIC"
