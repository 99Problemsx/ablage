...
module Essentials
  VERSION = "21.99"
  ERROR_TEXT = ""
  # Shattered Crowns Linux uses Luka's mkxp-z-ext build. This commit contains
  # the font/shader fixes required by the port and is intentionally different
  # from the stock Essentials v21.1 runtime.
  MKXPZ_VERSION = "2.4.2/2f2b824"
end
